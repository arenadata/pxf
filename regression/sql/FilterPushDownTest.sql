...
CREATE EXTERNAL TABLE test_filter (
    t0 text,
    a1 integer,
    b2 boolean,
    c3 numeric,
...
SET optimizer = off;
SELECT t0, a1, b2, c3, d4, e5, filterValue FROM test_filter WHERE t0 = 'J' AND a1 = 9 AND b2 = false AND c3 = 9.91 AND d4 = 'JJ' AND e5 = 'JJ' ORDER BY t0, a1;
